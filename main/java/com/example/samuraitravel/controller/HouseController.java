...
public class HouseController {
     ...
     public String unlike(@PathVariable(name = "id") Integer id, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
    	 likeService.removeLikes(id, userDetailsImpl.getUser().getId());
